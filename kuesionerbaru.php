...
<div class="container">
        ...
        <ul class="angkatan-list">
            ...
            <li onclick="window.location.href='angkatan-7.php'">Angkatan 7</li>
            <li onclick="window.location.href='angkatan-8.php'">Angkatan 8</li>
            <li onclick="window.location.href='angkatan-9.php'">Angkatan 9</li>
            <li onclick="window.location.href='angkatan-10.php'">Angkatan 10</li>
        </ul>
    </div>
    <style>
    .kuesioner-btn {
